...
function Favorites(props) {
  const filteredFavorites = props.favorites
          ...
          <div>
            ...
            <p className="text-muted-foreground flex items-center gap-2">
              <Badge variant="secondary" className="gap-1">
                ...
                {props.favorites.length} {props.favorites.length === 1 ? 'favorite' : 'favorites'}
              </Badge>
              {props.searchText && (
                <>
                  <span>•</span>
                  <Badge variant="outline">{filteredFavorites.length} matching search</Badge>
                </>
              )}
            </p>
          </div>
      ...
      {filteredFavorites.length > 0 ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-2xl font-semibold mb-2">
            {props.favorites.length === 0 ? 'No favorites yet' : 'No matching favorites'}
          </h3>
